...
public class IMCallFloatWindow {
    ...
    public void addFloatWindow() {
        ...
        if (IMCallManager.getInstance().getCallType() == IMCallManager.CallType.VOICE) {
        ...
        mFloatView.setOnClickListener((View v) -> {
            ...
            if (IMCallManager.getInstance().getCallType() == IMCallManager.CallType.VOICE) {
                ...
                //intent.setClass(context, IMCallVideoActivity.class);
            }
        ...
        mFloatView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    mLayoutParams.y = (int) (event.getRawY() - y - 25);
                    // 刷新悬浮窗
