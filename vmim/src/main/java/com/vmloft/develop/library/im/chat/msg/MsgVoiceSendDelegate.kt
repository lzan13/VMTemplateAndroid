 ...
 * 描述：展示语音消息 Item
 */
class MsgVoiceSendDelegate(longListener: BItemLongListener<IMMessage>) : MsgCommonDelegate<ImItemMsgVoiceSendDelegateBinding>(longListener = longListener) {
    ...
    override fun onBindView(holder: BItemHolder<ImItemMsgVoiceSendDelegateBinding>, item: IMMessage) {
