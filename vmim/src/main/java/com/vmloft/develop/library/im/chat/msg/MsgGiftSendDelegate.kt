 ...
 * 描述：展示礼物消息 Item
 */
class MsgGiftSendDelegate(listener: BItemListener<EMMessage>, longListener: BItemLongListener<EMMessage>? = null) : MsgCommonDelegate<ImItemMsgGiftSendDelegateBinding>(listener, longListener) {
    ...
    override fun onBindView(holder: BItemHolder<ImItemMsgGiftSendDelegateBinding>, item: EMMessage) {
        ...
        holder.binding.imMsgContentTV.text = VMStr.byResArgs(R.string.im_gift_msg_send, gift.title)
    }
}
