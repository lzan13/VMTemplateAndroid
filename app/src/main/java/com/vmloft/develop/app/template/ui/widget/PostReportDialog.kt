...
import com.vmloft.develop.app.template.databinding.WidgetPostReportDialogBinding
 ...
 * 描述：反馈屏蔽对话框
 */
class PostReportDialog(context: Context) : VMBDialog<WidgetPostReportDialogBinding>(context) {
    override fun initVB() = WidgetPostReportDialogBinding.inflate(LayoutInflater.from(context))
