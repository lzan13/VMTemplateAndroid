...
import com.vmloft.develop.library.common.databinding.WidgetCommonHeaderFluidLoadingBinding

/**
 * Create by lzan13 on 2021/9/17
 * 描述：自定义顶部下拉刷新样式
 */
class FluidLoadHeader @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0,
) : SimpleComponent(context, attrs, defStyleAttr), RefreshHeader {
    val mBinding = WidgetCommonHeaderFluidLoadingBinding.inflate(LayoutInflater.from(context), this, true)
...
//        super.onMoving(isDragging, percent, offset, height, maxDragHeight)
        mBinding.lottieAnimationView.alpha = percent
        mBinding.lottieAnimationView.scaleX = percent
        mBinding.lottieAnimationView.scaleY = percent
...
//        super.onStartAnimator(refreshLayout, height, maxDragHeight)
        // 设置动画资源
//        mBinding.lottieAnimationView.setAnimation("lottie/load_fluid.json")
        // 设置重复次数
//        mBinding.lottieAnimationView.repeatCount = LottieDrawable.INFINITE
        // 开始播放
